...
func (in *LeaderWorkerTemplate) DeepCopyInto(out *LeaderWorkerTemplate) {
	*out = *in
	...
	if in.SubGroupingPolicy != nil {
		in, out := &in.SubGroupingPolicy, &out.SubGroupingPolicy
		*out = new(SubGroupingPolicy)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SubGroupingPolicy) DeepCopyInto(out *SubGroupingPolicy) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SubGroupingPolicy.
func (in *SubGroupingPolicy) DeepCopy() *SubGroupingPolicy {
	if in == nil {
		return nil
	}
	out := new(SubGroupingPolicy)
