...
func ForKind(kind schema.GroupVersionKind) interface{} {
	...
	case v1.SchemeGroupVersion.WithKind("InPlaceGroupRestartConfig"):
		return &leaderworkersetv1.InPlaceGroupRestartConfigApplyConfiguration{}
	case v1.SchemeGroupVersion.WithKind("InPlaceGroupRestartTrigger"):
		return &leaderworkersetv1.InPlaceGroupRestartTriggerApplyConfiguration{}
