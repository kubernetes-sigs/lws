...
func TestAddTPUVariables(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			expectedTpuWorkerHostNames:  "test-sample-0.default,test-sample-0-0.default",
			expectedTpuName:             "test-sample-0",
			expectedTpuProcessAddresses: "test-sample-0.default:8476,test-sample-0-0.default:8476",
		...
		},
		{
			...
			size:                        2,
			expectedTpuWorkerId:         "0",
			expectedTpuWorkerHostNames:  "test-sample-0-0.default",
			expectedTpuName:             "test-sample-0",
			expectedTpuProcessAddresses: "test-sample-0-0.default:8476",
			expectedTpuProcessPort:      "8476",
		},
		{
			...
			size:                        2,
			expectedTpuWorkerId:         "0",
			expectedTpuWorkerHostNames:  "test-sample-0.default,test-sample-0.default,test-sample-0-0.default,test-sample-0-0.default",
			expectedTpuName:             "test-sample-0",
			expectedTpuProcessAddresses: "test-sample-0.default:8476,test-sample-0.default:8477,test-sample-0-0.default:8476,test-sample-0-0.default:8477",
			expectedTpuProcessPort:      "8476",
		},
		{
			...
			expectedTpuWorkerHostNames:  "test-sample-0.default,test-sample-0.default,test-sample-0-0.default,test-sample-0-0.default",
			expectedTpuName:             "test-sample-0",
			expectedTpuProcessAddresses: "test-sample-0.default:8478,test-sample-0.default:8479,test-sample-0-0.default:8478,test-sample-0-0.default:8479",
