...
func (r *LeaderWorkerSetWebhook) Default(ctx context.Context, obj runtime.Object) error {
	...
	if lws.Spec.LeaderWorkerTemplate.SubGroupPolicy != nil {
		if lws.Spec.LeaderWorkerTemplate.SubGroupPolicy.Type == "" {
			lws.Spec.LeaderWorkerTemplate.SubGroupPolicy.Type = v1.SubGroupPolicyLeaderWorker
		}
	}
	return nil
}
...
func validateUpdateSubGroupPolicy(specPath *field.Path, lws *v1.LeaderWorkerSet) field.ErrorList {
	...
	if (lws.Spec.LeaderWorkerTemplate.SubGroupPolicy.Type == v1.SubGroupPolicyLeaderExcluded) && (size%subGroupSize == 0) {
