...
- A Kubernetes cluster with version >= 1.34 is **Required** (officially supported and tested on Kubernetes 1.34 through 1.37), or it will behave unexpected. Learn how to [install the Kubernetes tools](https://kubernetes.io/docs/tasks/tools/).
