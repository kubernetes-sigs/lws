...
| `disaggregatedset.x-k8s.io/subrole`                  | The controller-assigned routing pool within a DisaggregatedSet role.              | short-context                  | Pod, Service, DisaggregatedSetRoleScaler |
